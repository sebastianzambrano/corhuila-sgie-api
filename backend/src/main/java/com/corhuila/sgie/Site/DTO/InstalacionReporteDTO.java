...
@NoArgsConstructor
@AllArgsConstructor
public class InstalacionReporteDTO {
    ...
    @ReportColumn(header = "Instalación", order = 6)
    private String nombreInstalacion;

    @ReportColumn(header = "Categoría Instalacion", order = 7)
    private String nombreCategoriaInstalacion;
}
